...
jQuery.extend(QueueManager.prototype, {
    ...
    enqueue: function(requestParams){
        ...
        this.log("QueueManager: enqueued request", requestParams);
    ...
    flushAll: function(){
        this.log("QueueManager: flushing all queues");
    ...
    flushQueue: function(hashKey){
        ...
        this.log("QueueManager: flushing queue for", queue.requestParams);
